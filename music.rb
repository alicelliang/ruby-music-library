...
def list_artists(generic_music_hash)
    generic_music_hash.each do |artists,songs|
        puts artists
    end
end
...
# This method should accept a hash as an argument.
def list_songs(generic_music_hash)
    generic_music_hash.each do |artists,songs|
        puts songs
    end
end
...
def delete_artist(generic_music_hash, artist)
   generic_music_hash.delete(artist)
   return generic_music_hash
end
...
def add_song_and_artist(library_hash,artist,song)
    library_hash[:ed_sheeran]="Thinking Out Loud"
    return library_hash
end